...
namespace SteamQueryNet
{
	public class ServerQuery : IServerQuery, IDisposable
	{
		...
		public IServerQuery Connect(IPEndPoint serverEndpoint)
		{
            PrepareAndConnect(serverEndpoint);
            return this;
        }
        ...
        private void PrepareAndConnect(IPEndPoint serverEndpoint)
        {
            m_port = (ushort) serverEndpoint.Port;
			m_remoteIpEndpoint = serverEndpoint;
