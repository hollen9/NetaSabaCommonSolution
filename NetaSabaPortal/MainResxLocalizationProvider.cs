...
namespace NetaSabaPortal
{
    ...
    /// </summary>
    public class MainResxLocalizationProvider : ResxLocalizationProviderBase
    {
        #region Dependency Properties
        /// <summary>DefaultDictionary
        ...
        /// </summary>
        private static MainResxLocalizationProvider _instance;
        ...
        /// <summary>
        /// Gets the <see cref="MainResxLocalizationProvider"/> singleton.
        /// </summary>
        public static MainResxLocalizationProvider Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    {
                        if (_instance == null)
                            _instance = new MainResxLocalizationProvider();
                    }
                }
        ...
        /// </summary>
        protected MainResxLocalizationProvider()
        {
